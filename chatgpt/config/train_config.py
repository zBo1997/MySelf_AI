...
def train_parse_args():
    ...
    parser.add_argument("--train_file_path", type=str, default=os.path.join(get_project_rootpath(), "data/train2.txt"),
                        help="train_file_path")

    parser.add_argument('--save_path', type=str, default=os.path.join(checkpoints_dir, "GPT2.pt"),
                        help='decay step')
